...
<div class="relative min-h-screen sm:flex sm:flex-row justify-center bg-transparent rounded-3xl shadow-xl">
  <div class="flex-col flex self-center lg:px-14 sm:max-w-4xl xl:max-w-md z-10">
    <div class="self-start hidden lg:flex flex-col text-gray-300">
      ...
      <p class="pr-3 text-sm opacity-75">"Website toko manga online dengan koleksi lengkap, harga terjangkau, dan pengiriman cepat untuk para penggemar manga di seluruh Indonesia."</p>
    </div>
  </div>
  ...
  <div class="flex justify-center self-center z-10">
    <div class="p-12 bg-white mx-auto rounded-3xl w-96">
      <div class="mb-7">
        ...
        <p class="text-gray-400">Don't have an account? <a href="#" class="text-sm text-purple-700 hover:text-purple-700">Sign Up</a></p>
      </div>
      ...
      <form action="index.php?modul=login" method="POST" class="space-y-6">
        <!-- Username Field -->
        <div>
          <input type="text" name="user_username" placeholder="Username" required class="w-full text-sm px-4 py-3 bg-gray-200 focus:bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400">
        </div>

        <!-- Password Field -->
        <div class="relative">
          <input type="password" name="user_password" placeholder="Password" required class="w-full text-sm px-4 py-3 bg-gray-200 focus:bg-gray-100 border border-gray-200 rounded-lg focus:outline-none focus:border-purple-400">
        </div>
        ...
        <div class="flex justify-center gap-5 w-full">
          ...
          <!-- Facebook Button -->
          <button type="button" class="w-full flex items-center justify-center mb-6 md:mb-0 border border-gray-300 hover:border-gray-900 hover:bg-gray-900 text-sm text-gray-500 p-3 rounded-lg tracking-wide font-medium cursor-pointer transition ease-in duration-500">
            <svg class="w-4 mr-2" viewBox="0 0 100 100" style="enable-background:new 0 0 100 100" xml:space="preserve" xmlns="http://www.w3.org/2000/svg">
...
<footer class="bg-transparent absolute w-full bottom-0 left-0 z-30">
  <div class="container p-5 mx-auto flex items-center justify-between">
    <div class="flex mr-auto">
      <a href="https://github.com/AnnZaryuu/OOPProject02" target="_blank" title="Ann Zaryuu" class="text-center text-gray-700 focus:outline-none">
        <img src="assets\bfb4b6bf038b30c42116828d2f539b30.jpg" alt="" class="object-cover mx-auto w-8 h-8 rounded-full w-10 h-10">
        <p class="text-xl">Ann<strong>Zaryuu</strong></p>
      </a>
    </div>
  </div>
</footer>
